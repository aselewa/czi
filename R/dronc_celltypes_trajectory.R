...
save(cluster.ids,file='dronc_cluster_ids')
...
DoHeatmap(ipsc, genes.use=top$gene, slim.col.label= TRUE, remove.key = TRUE,group.label.rot = T )

save(markers, file='dronc_markers')
